...
Config = {
    ...
    'baselinecorr_on_autophase': False
}
...
def FT1D(numb1, ppm_offset=0, autoph=True, ph0=0, ph1=0):
    ...
    if not autoph:
        ...
        d.bruker_corr().apmin(baselinecorr=Config['baselinecorr_on_autophase'])     # automatic phase correction
    d.unit = 'ppm'
    ...
    # new approach - oct 2019
    d.bcorr(method='spline', xpoints=6, nsmooth=d.size1//5000)
    return d
